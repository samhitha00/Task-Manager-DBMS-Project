                                ...
                                <p class="card-text">
                                    <form action="welcom.php" method="POST">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="password" class="form-control"name="psd" id="exampleInputPassword1">
                                        </div>
                                        <div class="g-recaptcha" data-sitekey="6LfkawAVAAAAANWjUOY9Rz9N600i7nwWGgfDJg52"></div>
